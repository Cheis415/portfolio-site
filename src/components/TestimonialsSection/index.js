...
const ScrollingTestimonials = () => {
  return (
    <div id="testimonials" className="bg-[#f9eac8] py-12">
      ...
      <div className="p-4 mt-12 overflow-x-hidden relative">
    ...
    >
      {list.map((t) => {
        return (
          <div
            key={t.id}
            className="shrink-0 w-[500px] grid grid-cols-[6rem,_1fr] overflow-hidden relative"
          >
            <img src={t.img} className="w-full h-44 object-cover" />
            <div className="bg-[#288998] text-slate-50 p-4">
              <span className="block text-[#ea6c32] font-semibold text-lg mb-1">{t.name}</span>
